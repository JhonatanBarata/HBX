...
export function applyThemeConfigToDocument(config?: HbxThemeConfig | HbxResolvedThemeConfig | null) {
  ...
  const variables: Record<string, string> = {
    ...
    "--text-secondary": palette.foregroundSoft,
    "--text-muted": palette.muted,
    "--text-inverse": selection.mode === "light" ? "#F8FBFF" : "#06101D",
    "--contrast-surface": palette.surface,
    "--contrast-surface-soft": palette.surfaceSoft,
    "--contrast-surface-raised": palette.surfaceRaised,
    "--contrast-line": palette.line,
    "--line": palette.line,
