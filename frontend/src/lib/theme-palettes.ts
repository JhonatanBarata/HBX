...
export const HBX_THEME_PALETTES: Record<HbxThemeId, HbxThemePalette> = {
  shadcn: {
    label: "Tema 1",
    shortLabel: "T1",
    inspiration: "Tema 1 / glass premium",
  ...
  mosaic: {
    label: "Tema 2",
    shortLabel: "T2",
    inspiration: "Tema 2 / couture glass",
    description: "Visual sofisticado com leitura alta, vidro autoral e sensacao de produto premium.",
    personality: "Presenca forte, futurista e facil de enxergar, com contraste claro para navegar.",
    shellLabel: "Base velvet premium",
  ...
  tabler: {
    label: "Tema 3",
    shortLabel: "T3",
    inspiration: "Tema 3 / fusion glass",
    description: "Base intensa com energia visual sem perder leitura operacional.",
    personality: "Futurista, inclusivo e legivel, com brilho tecnico e profundidade cinematografica.",
    shellLabel: "Base fusion premium",
