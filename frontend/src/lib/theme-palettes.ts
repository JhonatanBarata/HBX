...
export const HBX_THEME_PALETTES: Record<HbxThemeId, HbxThemePalette> = {
  ...
  mosaic: {
    ...
    light: {
      ...
      brandStrong: "#9d174d",
      brandSoft: "#fde7f3",
      brandContrast: "#fff8fc",
      background: "#fff3f8",
      backgroundAlt: "#ffe5f0",
      surface: "#ffffff",
      surfaceSoft: "#fff9fc",
      surfaceRaised: "#fff0f7",
      headerSurface: "rgba(255,255,255,0.8)",
      navSurface: "rgba(255,248,252,0.94)",
      fieldSurface: "#fffafd",
      heroFrom: "rgba(255,255,255,0.96)",
      heroTo: "rgba(255,232,242,0.98)",
      heroSpotlight: "rgba(190,24,93,0.18)",
      tableHead: "#fff1f7",
      chatInbound: "#ffffff",
      chatOutbound: "#ffe0ee",
      chatSystem: "#fff0f7",
      foreground: "#4a1028",
      foregroundSoft: "#67223d",
      muted: "#7b4b63",
      line: "#f4c5da",
      success: "#0f8a6f",
      warning: "#c47a09",
      ...
      info: "#be185d",
      shadow: "#4a1028",
      overlay: "rgba(58, 13, 33, 0.2)",
    },
    dark: {
      brand: "#f472b6",
      brandStrong: "#ec4899",
      brandSoft: "#4a1532",
      brandContrast: "#250714",
      background: "#180611",
      backgroundAlt: "#240a19",
      surface: "#2a0d1d",
      surfaceSoft: "#351326",
      surfaceRaised: "#431a31",
      headerSurface: "rgba(28,9,20,0.84)",
      navSurface: "rgba(42,13,29,0.96)",
      fieldSurface: "#2a0d1d",
      heroFrom: "rgba(42,13,29,0.95)",
      heroTo: "rgba(27,8,19,0.98)",
      heroSpotlight: "rgba(244,114,182,0.2)",
      tableHead: "#311122",
      chatInbound: "#311122",
      chatOutbound: "#4a1833",
      chatSystem: "#391326",
      foreground: "#ffe4f0",
      foregroundSoft: "#ffd1e4",
      muted: "#d39ab8",
      line: "#6b3350",
      success: "#34d399",
      warning: "#fbbf24",
