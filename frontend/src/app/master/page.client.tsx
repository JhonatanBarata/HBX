    ...
    <DashboardScaffold
      ...
      actions={
        <div className={styles.heroActions}>
          <Link href="/master/sistema" className="btn btn-primary btn-sm">
            Hostinger
          </Link>
          <Link href="/master/clientes" className="btn btn-secondary btn-sm">
            Clientes
          </Link>
          <Link href="/master/financeiro" className="btn btn-secondary btn-sm">
            Financeiro
          </Link>
          <Link href="/master/whatsapp" className="btn btn-secondary btn-sm">
            WhatsApp
          </Link>
          <Link href="/master/planos" className="btn btn-secondary btn-sm">
            Planos/Módulos
          </Link>
        ...
        <section className={styles.masterHomeHero}>
          ...
          <aside className={styles.hostingerStatus}>
            ...
            <div className={styles.hostingerLinks}>
              <Link href="/master/sistema">Saúde do sistema</Link>
