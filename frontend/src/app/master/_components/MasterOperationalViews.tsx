...
const MASTER_NAV: Array<{ id: MasterArea | "home" | "operacao"; label: string; href: string }> = [
  ...
  { id: "planos", label: "Planos/Módulos", href: "/master/planos" },
  { id: "operacao", label: "Operação completa", href: "/master/operacao" },
];
...
function operationHref(company: CompanySummary, tab: DrawerTab = "summary") {
  ...
  return `/master/operacao?companyId=${company.id}&tab=${operationTab}`;
}
                ...
                <section className={styles.summaryCard}>
                  <div className={styles.panelCardHeader}>
                    ...
                    <div className={styles.rowActions}>
                      ...
                      <Link href="/master/whatsapp" className="btn btn-secondary btn-sm">Ver WhatsApp Master</Link>
                    </div>
                  </div>
                  <div className={styles.summaryStats}>
    ...
    return (
      <DashboardScaffold title={AREA_COPY[area].title} description="Acesso exclusivo do usuário MASTER.">
        <section className={styles.masterHomeAccess}>
          ...
          <Link href="/boasvindas" className="btn btn-secondary btn-sm">Voltar ao painel</Link>
        </section>
      </DashboardScaffold>
    );
  }
    ...
    <DashboardScaffold
      ...
      actions={
        <div className={styles.heroActions}>
          ...
          <Link href="/master/operacao" className="btn btn-primary btn-sm">
            Operação completa
          </Link>
        </div>
      }
