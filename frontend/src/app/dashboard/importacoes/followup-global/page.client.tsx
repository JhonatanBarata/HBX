    ...
    <DashboardScaffold
      ...
      actions={
        <div className="flex gap-2">
          ...
          <Link href="/dashboard/importacoes/novo" className="btn btn-success btn-sm">Novo pedido</Link>
          <Link href="/dashboard/importacoes/historico" className="btn btn-secondary btn-sm">Historico</Link>
        </div>
      }
    >
              ...
              <div key={item.id} className="border border-[var(--line)] rounded-[12px] bg-[var(--surface-soft)] p-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link href={`/dashboard/importacoes/editar/${item.id}`} className="btn btn-secondary btn-sm" title="Editar pedido" aria-label="Editar pedido">✏️</Link>
                    {isAdmin ? (
