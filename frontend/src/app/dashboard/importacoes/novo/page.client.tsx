...
export default function NewImportacaoClientPage() {
  ...
  return (
    <DashboardScaffold
      ...
      actions={<Link href="/dashboard/importacoes/cadastros" className="btn btn-secondary btn-sm">Cadastrar</Link>}
    >
      ...
      <form onSubmit={submit} className="panel p-4">
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button type="button" className="btn btn-secondary" onClick={() => router.push("/dashboard/importacoes/followup-global")}>Cancelar</button>
        </div>
      </form>
    </DashboardScaffold>
  );
