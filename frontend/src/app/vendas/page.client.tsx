          ...
          >
            <div className={styles.mobileVendasVisualFilterScroller}>
              {MOBILE_VISUAL_FILTERS.map((filter) => {
                ...
                return (
                  <button
                    ...
                    title={mobileVisualFiltersUnlocked ? filter.label : "Disponivel no HBX Lead"}
              ...
              <button
                ...
                title={mobileMinScoreFilter ? `Score minimo ${mobileMinScoreFilter}+` : "Filtrar por score"}
                aria-label={mobileMinScoreFilter ? `Score minimo ${mobileMinScoreFilter}+` : "Abrir filtro de score"}
              ...
              >
                ...
                <div>
                  <button
                    ...
                    aria-label="Diminuir score minimo"
                  >
                    -
                  </button>
                  <button
                    type="button"
                    disabled={mobileMinScoreFilter >= 100}
                    onClick={() => stepMobileScoreFilter(5)}
                    aria-label="Aumentar score minimo"
                  >
                    +
                  </button>
                  <button
