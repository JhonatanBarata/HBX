        ...
        <div className={styles.mobileVendasContextBar}>
          ...
          >
            <div className={styles.mobileVendasVisualFilterScroller}>
              ...
              <details
                className={styles.mobileVendasScoreDisclosure}
                data-active={mobileMinScoreFilter > 0 ? "true" : "false"}
                data-locked={mobileVisualFiltersUnlocked ? "false" : "true"}
              >
                <summary
                  className={styles.mobileVendasScoreShortcut}
                  onClick={(event) => {
                    if (!mobileVisualFiltersUnlocked) event.preventDefault();
                  }}
                  aria-label={mobileMinScoreFilter > 0 ? "Ocultar filtro de score" : "Mostrar filtro de score"}
                >
                  <span aria-hidden="true" />
                </summary>
                <div
                ...
                >
                  ...
                  <span>
                    <MobileLeadScoreGauge
                      ...
                      label={mobileVisualFiltersUnlocked ? "Score" : "â™•"}
              ...
              <button
                ...
                aria-label="Limpar filtros visuais"
                title="Limpar filtros visuais"
              >
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    d="M9 3h6l1 2h4"
