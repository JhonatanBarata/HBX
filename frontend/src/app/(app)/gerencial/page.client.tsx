          ...
          {user && !isAdmin && (
            <section className="panel">
              <div style={{ padding: 18 }}>
                <strong style={{ fontSize: "var(--fz-n3)" }}>Área do administrador</strong>
                <p style={{ margin: "6px 0 0", fontSize: "var(--fz-l3)", color: "var(--text-muted)" }}>
          ...
          {isAdmin && (
            <React.Fragment>
              ...
              {aba === 1 && (
                <React.Fragment>
                  {comissoesErro && (
                    <section className="panel"><div style={{ padding: 16, fontSize: "var(--fz-l3)", color: "var(--hbx-danger)", fontWeight: 600 }}>{comissoesErro}</div></section>
                  )}
                    ...
                    {[
                      ...
                      <div className="kpi" key={k.l}>
                        <div>
                          ...
                          <div className="kpi-value" style={{ fontSize: "var(--fz-t9)" }}>{comissoes ? k.v : "—"}</div>
                        ...
                        <tbody>
                          ...
                          {(comissoes?.clients?.payable || []).map(c => (
                            <tr key={c.leadId} style={{ cursor: "default" }}>
                              ...
                              <td style={{ fontFamily: "var(--font-mono)", fontSize: "var(--fz-m2)" }}>{fmtData(c.commissionDueAt)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                          ...
                          <tbody>
                            ...
                            {(comissoes?.clients?.pendingActivation || []).map(c => (
                              <tr key={c.leadId} style={{ cursor: "default" }}>
                                ...
                                <td style={{ fontFamily: "var(--font-mono)", fontSize: "var(--fz-m1)" }}>{fmtBRL(c.saleValue)}</td>
              ...
              {aba === 3 && (
                <section className="panel">
                  <div style={{ padding: 18, fontSize: "var(--fz-l2)", color: "var(--text-muted)" }}>
        ...
        <div className="hbx-veil" onClick={e => { if (e.target === e.currentTarget) setPayoutOpen(false); }}>
          <form className="hbx-modal" onSubmit={gerarPayout}
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
              <div style={{ flex: 1 }}>
                <strong style={{ fontSize: "var(--fz-l2)" }}>Incluir não vencidas</strong>
