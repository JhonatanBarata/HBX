  ...
  return (
    <React.Fragment>
      <section className="panel">
        ...
        {acaoMsg && (
          <div style={{ padding: "0 16px 10px", fontSize: "var(--fz-m1)", fontWeight: 700, color: acaoMsg.startsWith("✓") ? "var(--hbx-brand-strong)" : "var(--hbx-warning)" }}>{acaoMsg}</div>
        )}
        {loadError && <div style={{ padding: "0 16px 12px", fontSize: "var(--fz-l3)", fontWeight: 600, color: "var(--hbx-danger)" }}>{loadError}</div>}
        {companyId && (
        ...
        {!companyId && (
          <div style={{ padding: "0 16px 16px", fontSize: "var(--fz-l3)", color: "var(--text-muted)" }}>
