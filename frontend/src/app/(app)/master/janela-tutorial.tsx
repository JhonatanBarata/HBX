  ...
  if (!manifest) {
    return (
      <section className="panel">
        ...
        <div style={{ padding: 20, fontSize: "var(--hbx-font-min)" }}>Carregando…</div>
      </section>
    );
  }
    ...
    <section className="panel">
      <div className="panel-head">
        ...
        <div className="meta">
          ...
          <button className="btn-teal" style={{ minHeight: 30, fontSize: "var(--hbx-font-min)" }} onClick={() => void salvar()} disabled={busy || !dirty}>
