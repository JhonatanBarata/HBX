          ...
          {perfilLento ? (
            <section className="panel" style={{ maxWidth: 420 }}>
              <div style={{ padding: 20, display: "grid", gap: 10 }}>
                <strong style={{ fontSize: "var(--fz-n3)" }}>Não foi possível carregar seu perfil</strong>
      ...
      <div className="app">
        <div className="main" style={{ display: "grid", placeItems: "center", minHeight: "60vh", padding: 24 }}>
          <section className="panel" style={{ maxWidth: 460 }}>
            <div style={{ padding: 20, display: "grid", gap: 10 }}>
              <strong style={{ fontSize: "var(--fz-n3)" }}>Acesso restrito</strong>
              <span style={{ fontSize: "var(--fz-l3)", color: "var(--text-muted)", lineHeight: 1.55 }}>
    ...
    <div className="app">
          ...
          <div className="user-card" style={{ position: "relative" }}>
            ...
            {menuOpen && (
              <div className="hbx-pop" style={{ position: "absolute", right: 8, bottom: "calc(100% + 6px)", zIndex: 20, minWidth: 120, padding: 6 }}>
                <button className="btn-ghost" style={{ width: "100%", minHeight: 32, fontSize: "var(--fz-m1)" }} onClick={sair} disabled={signingOut}>
      ...
      <div className="main">
        ...
        <div className="work" style={{ flex: 1 }}>
          {(ctx?.active || ctxMsg) && (
            <div style={{ display: "flex", gap: 10, alignItems: "center", padding: "9px 14px", borderRadius: "var(--radius-sm)", border: "1px solid var(--hbx-warning)", background: "color-mix(in srgb, var(--hbx-warning) 8%, transparent)", fontSize: "var(--fz-l3)" }}>
              {ctx?.active ? (
                <React.Fragment>
                  ...
                  <button className="btn-ghost" style={{ marginLeft: "auto", minHeight: 28, fontSize: "var(--hbx-font-min)" }} disabled={ctxBusy} onClick={sairContexto}>
