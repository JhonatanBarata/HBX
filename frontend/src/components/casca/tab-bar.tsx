...
// MOBILE-CASCA/W1 — TAB BAR da casca (54–56px): Vendas · Conversas · Empresas ·
// Rota (gate isModuleVisible) · Mais. A aba "Buscar" NÃO existe (Buscar vive
// dentro de Vendas). Item ativo pelo pathname. Rota → /entrega (app próprio,
// skin do W6). "Mais" → /configuracoes (W5 troca por uma folha "Mais").
//
// Navegar troca a rota; a MobileShell reage ao pathname e anima IR/VOLTAR.
// Zero visual solto — classes .casca-tab* (casca.css). Ícones do ICONS central.
...
const TABS: Tab[] = [
  ...
  // "Mais" nunca é gated — é a folha de tudo que não coube nas 4 abas.
...
function isTabActive(tab: Tab, pathname: string): boolean {
  ...
  if (tab.key === "mais") {
    // "Mais" acende em qualquer rota que não seja uma das 4 abas fixas nem /entrega.
