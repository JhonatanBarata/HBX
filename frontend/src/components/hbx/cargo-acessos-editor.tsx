...
// Configurações → Equipe → "Acesso do cargo Vendedor" (PR13062026007 P4: a TELA
// que faltava). Receita de ACESSO do cargo Vendedor, 1 por empresa — acesso por
// CARGO, não por pessoa. O Gerente (ADMIN) herda tudo que a empresa tem; só o
// Vendedor passa por esta peneira. Financeiro/Gerencial são muro no backend
// (nunca aparecem aqui). Só lista módulo que a empresa já tem ligado.
  ...
  return (
    <section className="panel">
      <div className="panel-head">
        <h2>Acesso do cargo Vendedor</h2>
        <div className="meta">
      ...
      <div style={{ padding: "10px 16px 16px", display: "grid", gap: 12 }}>
        <div className="meta">
          Acesso por <strong>cargo</strong>, não por pessoa: vale para todos os vendedores da empresa de uma vez.
          O <strong>Gerente</strong> herda tudo que a empresa tem; só o <strong>Vendedor</strong> passa por esta peneira.
          Aparecem aqui só os módulos que a empresa já tem ligados — Financeiro e Gerencial nunca entram para vendedor.
        </div>
