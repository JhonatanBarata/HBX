...
const DEFAULT_TEMPLATE_COMPOSER: RecoveryTemplateComposer = {
  ...
  headerMediaUrl: "",
  bodyText:
    "Ol├í, tudo bem? Aqui ├® da {{empresa}}.\nFalo com {{cliente}}?\nTemos um assunto financeiro pendente referente ao servi├ºo realizado em {{data_servico}}.\nPodemos conversar sobre op├º├Áes de pagamento?",
  footerText: "",
  buttonsText: "Sim\nN├úo, obrigado",
  variableExamples: {},
  activateInHbx: true,
...
export default function HbxRecoveryClientPage() {
  ...
  async function loadPaymentHistory(month = paymentMonth, lifecycle = paymentFilter) {
    ...
    try {
      ...
      const reason = error instanceof Error ? error.message : "Erro ao carregar hist├│rico de pagamentos";
      setNotice(`Falha no hist├│rico de pagamentos: ${reason}`);
    } finally {
  ...
  async function loadInteractionDetail(conversationId: number) {
    ...
    try {
      ...
      // Only clear drafts when selecting a different conversation ÔÇö
  ...
  return (
    <>
      ...
      <DashboardScaffold
        title="Recovery"
        description="Gest├úo inteligente de inadimpl├¬ncia com score de risco, cobran├ºa automatizada e leitura clara do impacto financeiro."
      ...
      >
              ...
              <div className={styles.tableToolbar}>
                ...
                <div className={styles.batchActions}>
                  <span className={styles.selectionMeta}>
                    {selectedFilteredCustomersCount} selecionados ┬À {filteredCustomers.length} visiveis
                  </span>
                  <button
                    type="button"
                    className="btn btn-ghost btn-sm"
        ...
        <section>
          <article className={`panel ${styles.sectionCard}`}>
            <div className={styles.sectionHeader}>
              <div>
                <p className={styles.sectionEyebrow}>Intelig├¬ncia de recupera├º├úo</p>
                <h2 className={styles.sectionTitle}>Gr├ífico de recupera├º├úo mensal</h2>
                <p className={styles.sectionDescription}>
            ...
            <div className={styles.chartSurface}>
              <svg
                ...
                role="img"
                aria-label="Gr├ífico de recupera├º├úo mensal"
              >
                      ...
                      <div className={styles.interactionChatPanel}>
                        <div className={styles.interactionListToolbar}>
                          <div>
                            ...
                            <p className={styles.historyMeta}>
                              Visualiza├º├úo mais pr├│xima do WhatsApp. Eventos internos podem ser ocultados.
                            </p>
                          </div>
                        ...
                        {visibleInteractionMessages.length === 0 ? (
                          <div className={styles.paymentEmpty}>
                            Nenhuma mensagem vis├¡vel com o filtro atual.
                          </div>
                        ) : (
