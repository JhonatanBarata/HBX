# HBX — Tema ESCURO (referência de design)
...
- marketing/ — site público (visual único, escuro com mint)\n- assets/ — ícones SVG e logo
...
Nesta pasta os arquivos já vêm com o atributo do modo ESCURO fixado.
