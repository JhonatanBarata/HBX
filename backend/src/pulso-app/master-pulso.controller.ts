 ...
 * PLATAFORMA — o dono olhando a frota inteira de aparelhos. Admin de tenant
 * NÃO vê isto no v1, por decisão do plano; se um dia ver, nasce endpoint
 * próprio escopado por empresa, nunca este com um `if`.
 *
...
export class MasterPulsoController {
  ...
  /** Uma linha por aparelho: quem está com o app aberto agora e em qual tela. */
  @Get()
  @UseGuards(JwtAuthGuard, MasterGuard)
  listar() {
    return this.pulso.listarAparelhos();
  }
