...
@Module({
  ...
  providers: [WebscrapingService, HbxEnginePoolService, HbxEngineDockerAdapterService, HbxEngineTelemetryService, HbxEngineGovernorService, RadarMissionQueueService, RadarFabricaService, ...RADAR_SERVICES],
