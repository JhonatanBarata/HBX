...
export class RadarSourcePlannerService {
  ...
  private reasonFor(source: RadarLeadSourceKind) {
    const reasons: Record<RadarLeadSourceKind, string> = {
      ...
      radar_web_enrichment: 'enriquecimento_assincrono_gratuito_depois_da_descoberta',
      website_crawl_light: 'crawl_leve_do_site_oficial_sem_bloquear_a_busca',
