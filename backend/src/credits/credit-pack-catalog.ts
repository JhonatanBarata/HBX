...
const CREDIT_PACK_BASE: Record<CreditPackKey, CreditPackDefinition> = {
  [CREDIT_PACK_KEYS.STARTER]: {
    ...
    observation: 'Recarga de entrada — preço e quantidade editáveis no master.',
    badge: null,
    recommended: false,
  },
  [CREDIT_PACK_KEYS.GROWTH]: {
    ...
    price: 247.0,
    defaultExpiryDays: DEFAULT_CREDIT_EXPIRY_DAYS,
    observation: 'Recarga intermediária — preço e quantidade editáveis no master.',
    badge: 'Mais vendido',
    recommended: true,
  },
  [CREDIT_PACK_KEYS.SCALE]: {
    ...
    price: 597.0,
    defaultExpiryDays: DEFAULT_CREDIT_EXPIRY_DAYS,
    observation: 'Recarga de maior volume — preço e quantidade editáveis no master.',
    badge: null,
    recommended: false,
  },
};
