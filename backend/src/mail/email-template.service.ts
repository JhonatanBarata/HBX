...
const EMAIL_TEMPLATE_VARIABLES: EmailTemplateVariableDefinition[] = [
  ...
  { key: 'linkConfirmacao', token: '{linkConfirmacao}', label: 'Link confirmação', group: 'links', description: 'Link de confirmação de e-mail.', kinds: ['email_confirmation', 'seller_onboarding_request'] },
...
const DEFAULT_TEMPLATES: Record<EmailTemplateKind, EmailTemplate> = {
  ...
  seller_onboarding_request: {
    ...
    text: [
      ...
      '{documentosFaltantes}',
      '',
      'Abra o link abaixo para enviar os documentos pendentes em PDF, JPG ou PNG.',
      '{instrucaoAssinatura}',
      'Envie o contrato assinado em PDF junto com os demais documentos obrigatórios.',
      '',
      'Checklist de documentos:',
      '{linkConfirmacao}',
      '',
      'Importante: o e-mail será confirmado quando todos os documentos obrigatórios forem enviados. Assim que confirmado, chegará um e-mail com seu usuário e senha.',
      '',
