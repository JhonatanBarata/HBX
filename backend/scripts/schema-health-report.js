...
const healthChecks = [
  ...
  column('user.sellerDistributionMode', 'user-sales-profile-columns', 'User', 'sellerDistributionMode', true),
  ...
  table('radarAutoDistributionRule.table', 'radar-auto-distribution-rule-tables', 'RadarAutoDistributionRule', true),
  column('radarAutoDistributionRule.adminDailyLimit', 'radar-distribution-daily-usage-tables', 'RadarAutoDistributionRule', 'adminDailyLimit', true),
  column('radarAutoDistributionRule.dailyLimitPerSeller', 'radar-distribution-daily-usage-tables', 'RadarAutoDistributionRule', 'dailyLimitPerSeller', true),
  table('radarDistributionDailyUsage.table', 'radar-distribution-daily-usage-tables', 'RadarDistributionDailyUsage', true),
