-- Align Prisma schema with the AUVO scaffold already expected by the codebase.
-- Keep this idempotent because the repository has historical drift in structural migrations.
