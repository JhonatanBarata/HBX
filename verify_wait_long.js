...
(async () => {
  ...
  console.log('esperando 10s para qualquer HMR se estabilizar...');
  ...
  const finalCount = await page.locator('.casca-sheet').count();
  console.log('FINAL sheet count:', finalCount);
