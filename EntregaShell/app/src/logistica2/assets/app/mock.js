...
<div class="body">
  ...
  <div class="campos">
    ...
    <div class="dupla">
      ...
      <!-- CPF é SÓ LEITURA: o UpdateContaDto do backend não tem porta pra
           gravar documento. Campo que aceita digitação e não salva é pior que
           campo ausente — então ele MOSTRA, e não promete. -->
      <label class="campo"><label>CPF</label><input placeholder="000.000.000-00" value="${f.cpf}" data-campo="cpf" readonly></label>
    </div>
  </div>
